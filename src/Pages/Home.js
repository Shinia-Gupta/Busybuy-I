    ...
    return (
        ...
        <div className="container mx-auto px-4 pt-20">
            <div className='flex justify-center items-center mb-5'>
                <input type='text' placeholder='Search by Name or Product Id' onChange={(e)=>setSearch(e.target.value)} value={searchProd} className='w-2/5 h-full p-5 rounded-xl max-xl border mt-2 border-orange-400' />
            </div>
